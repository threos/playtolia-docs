...
Easily integrate different Playtolia services in your game to add more capabilities and enable next-level in-game features.

<CardGroup cols={2}>
  <Card title="Authentication" icon="arrow-right-to-bracket">
    Allow your users to sign-in to their accounts with Google, Facebook, Apple, Discord, or simply their email and password.
  </Card>
