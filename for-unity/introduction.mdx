...
<Note>
    ...
    During runtime, Playtolia.Unity acts as a ***bridge*** between your Unity ***scene, C# scripts, and the Playtolia.Core*** library.\
    Playtolia.Unity is the wrapper that allows you to use Playtolia services in your Unity project without having to worry about Java references or native libraries.
