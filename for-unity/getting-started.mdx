...
<Steps>
  <Step title="Getting the SDK">
    <Card title="Get Playtolia Unity SDK" icon="download" href="https://github.com/Playtolia/unity-sdk/releases/download/v1.0.0-alpha.20/PlaytoliaSDK-alpha-20.unitypackage">
      Latest release (1.0.0-alpha.20)
    </Card>
  </Step>
