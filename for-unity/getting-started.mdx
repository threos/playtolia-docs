...
<Steps>
  <Step title="Getting the SDK">
    <Card title="Get Playtolia Unity SDK" icon="download" href="https://github.com/Playtolia/unity-sdk/releases/download/v1.1.0%2B2/PlaytoliaSDK-110+2.unitypackage">
      Latest release (1.1.0+2)
    </Card>
  </Step>
