...
<Steps>
  <Step title="Getting the SDK">
    <Card title="Get Playtolia Unity SDK" icon="download" href="https://github.com/Playtolia/unity-sdk/releases/download/v1.0.0-alpha.18/PlaytoliaSDK-alpha-18.unitypackage">
      Latest release (1.0.0-alpha.18)
    </Card>
  </Step>
